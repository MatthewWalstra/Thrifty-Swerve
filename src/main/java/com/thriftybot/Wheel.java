...
public class Wheel {
   ...
   * @param ticks number of ticks in 1 revolution of azimuth
   * @param invertError boolean for flipping error if forms x rather than a circle when applying only yaw
   */
  public Wheel(
