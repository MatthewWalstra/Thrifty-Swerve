...
#include "Thriftybot/MotorControllerWrapper.h"

#include <frc/smartdashboard/SmartDashboard.h>

#include "Thriftybot/Util.h"
#include "Thriftybot/MotorControllerWrapper.h"
...
class Wheel {
 ...
 public:
   ...
   */
  Wheel();
  Wheel(std::shared_ptr<MotorControllerWrapper> azimuth, std::shared_ptr<MotorControllerWrapper> drive, double driveSetpointMax, int id, int ticks, bool invertError);
